...
angular.module('app')
    .directive('headerTitle', [
        '$rootScope', '$timeout', '$http', 'site_config', '$stateParams',
        function ($rootScope, $timeout, $http, site_config, $stateParams) {
            return {
                link: function (scope, element) {
                    ...
                    var listener = function (event, toState) {
                        ...
                        if (typeof($stateParams.campaign_name) != "undefined") {
                            $http.get(site_config.apiUrl + "api/get_campaign_name?slug=" + $stateParams.campaign_name).then(function (response) {
